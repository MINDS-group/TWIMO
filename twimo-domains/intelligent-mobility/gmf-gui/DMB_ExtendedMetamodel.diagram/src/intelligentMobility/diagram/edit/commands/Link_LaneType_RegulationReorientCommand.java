 ...
 * @generated
 */
public class Link_LaneType_RegulationReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public Link_LaneType_RegulationReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof intelligentMobility.Link_LaneType_Regulation) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return intelligentMobility.diagram.edit.policies.DrivingBehaviourMetamodelBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistLink_LaneType_Regulation_4001(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return intelligentMobility.diagram.edit.policies.DrivingBehaviourMetamodelBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistLink_LaneType_Regulation_4001(container, getLink(), source, getNewTarget());
	}
	...
	* @generated
	*/
	protected intelligentMobility.Link_LaneType_Regulation getLink() {
		return (intelligentMobility.Link_LaneType_Regulation) getElementToEdit();
	}
