 ...
 * @generated
 */
public class Link_EnvironmentCondition_RegulationsReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public Link_EnvironmentCondition_RegulationsReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof intelligentMobility.Link_EnvironmentCondition_Regulations) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return intelligentMobility.diagram.edit.policies.DrivingBehaviourMetamodelBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistLink_EnvironmentCondition_Regulations_4030(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return intelligentMobility.diagram.edit.policies.DrivingBehaviourMetamodelBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistLink_EnvironmentCondition_Regulations_4030(container, getLink(), source, getNewTarget());
	}
	...
	* @generated
	*/
	protected intelligentMobility.Link_EnvironmentCondition_Regulations getLink() {
		return (intelligentMobility.Link_EnvironmentCondition_Regulations) getElementToEdit();
	}
