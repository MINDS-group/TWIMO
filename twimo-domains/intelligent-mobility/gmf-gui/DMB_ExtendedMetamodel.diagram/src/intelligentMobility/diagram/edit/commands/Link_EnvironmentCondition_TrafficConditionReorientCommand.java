 ...
 * @generated
 */
public class Link_EnvironmentCondition_TrafficConditionReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public Link_EnvironmentCondition_TrafficConditionReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof intelligentMobility.Link_EnvironmentCondition_TrafficCondition) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return intelligentMobility.diagram.edit.policies.DrivingBehaviourMetamodelBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistLink_EnvironmentCondition_TrafficCondition_4017(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		intelligentMobility.Traffic_Situation source = getLink().getLink_trafficCondition();
		if (!(getLink().eContainer() instanceof intelligentMobility.MobilitySystem)) {
			return false;
		}
		intelligentMobility.MobilitySystem container = (intelligentMobility.MobilitySystem) getLink().eContainer();
		return intelligentMobility.diagram.edit.policies.DrivingBehaviourMetamodelBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistLink_EnvironmentCondition_TrafficCondition_4017(container, getLink(), source, getNewTarget());
	}
	...
	*/
	protected CommandResult reorientSource() throws ExecutionException {
		getLink().setLink_trafficCondition(getNewSource());
	...
	* @generated
	*/
	protected intelligentMobility.Link_EnvironmentCondition_TrafficCondition getLink() {
		return (intelligentMobility.Link_EnvironmentCondition_TrafficCondition) getElementToEdit();
	}

	/**
	* @generated
	*/
	protected intelligentMobility.Traffic_Situation getOldSource() {
	...
	* @generated
	*/
	protected intelligentMobility.Traffic_Situation getNewSource() {
