 ...
 * @generated
 */
public class Environment_BackgroundNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public Environment_BackgroundNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = intelligentMobility.diagram.providers.DrivingBehaviourMetamodelParserProvider.getParser(
					...
					intelligentMobility.diagram.part.DrivingBehaviourMetamodelVisualIDRegistry.getType(
							intelligentMobility.diagram.edit.parts.Environment_BackgroundNameEditPart.VISUAL_ID));
		}
		return parser;
	}
