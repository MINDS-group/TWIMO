...
/**
 * This is the item provider adapter for a {@link intelligentMobility.Action} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IntelligentMobilityPackage.eINSTANCE.getAction_ActionType(),
				 true,
				 false,
				 false,
	...
	protected void addTimestampPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Action_timestamp_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Action_timestamp_feature", "_UI_Action_type"),
				 IntelligentMobilityPackage.eINSTANCE.getAction_Timestamp(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Action)object).getActionType();
