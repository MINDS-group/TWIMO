 ...
 * @generated
 */
public class DrivingBehaviourMetamodelDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	* @generated
	*/
	public DrivingBehaviourMetamodelDomainNavigatorContentProvider() {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof intelligentMobility.diagram.navigator.DrivingBehaviourMetamodelDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier.getChildren(
					((intelligentMobility.diagram.navigator.DrivingBehaviourMetamodelDomainNavigatorItem) parentElement)
							.getEObject()),
					parentElement);
		}
		return EMPTY_ARRAY;
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new intelligentMobility.diagram.navigator.DrivingBehaviourMetamodelDomainNavigatorItem(
