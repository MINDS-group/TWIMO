 ...
 * @generated
 */
public class Link_NormalBehaviour_FollowingReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public Link_NormalBehaviour_FollowingReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof intelligentMobility.Link_NormalBehaviour_Following) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return intelligentMobility.diagram.edit.policies.DrivingBehaviourMetamodelBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistLink_NormalBehaviour_Following_4034(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return intelligentMobility.diagram.edit.policies.DrivingBehaviourMetamodelBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistLink_NormalBehaviour_Following_4034(container, getLink(), source, getNewTarget());
	}
	...
	* @generated
	*/
	protected intelligentMobility.Link_NormalBehaviour_Following getLink() {
		return (intelligentMobility.Link_NormalBehaviour_Following) getElementToEdit();
	}
