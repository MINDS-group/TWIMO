 ...
 * @generated
 */
public class Link_CommunicationInterface_InfrastructureReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public Link_CommunicationInterface_InfrastructureReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof intelligentMobility.Link_CommunicationInterface_Infrastructure) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return intelligentMobility.diagram.edit.policies.DrivingBehaviourMetamodelBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistLink_CommunicationInterface_Infrastructure_4039(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		intelligentMobility.CommunicationInterface source = getLink().getLink_communicationInterface();
		if (!(getLink().eContainer() instanceof intelligentMobility.MobilitySystem)) {
			return false;
		}
		intelligentMobility.MobilitySystem container = (intelligentMobility.MobilitySystem) getLink().eContainer();
		return intelligentMobility.diagram.edit.policies.DrivingBehaviourMetamodelBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistLink_CommunicationInterface_Infrastructure_4039(container, getLink(), source, getNewTarget());
	}
	...
	*/
	protected CommandResult reorientSource() throws ExecutionException {
		getLink().setLink_communicationInterface(getNewSource());
	...
	* @generated
	*/
	protected intelligentMobility.Link_CommunicationInterface_Infrastructure getLink() {
		return (intelligentMobility.Link_CommunicationInterface_Infrastructure) getElementToEdit();
	}
