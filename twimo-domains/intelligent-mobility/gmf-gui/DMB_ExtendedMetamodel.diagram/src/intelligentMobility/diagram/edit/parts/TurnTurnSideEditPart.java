 ...
 * @generated
 */
public class TurnTurnSideEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TurnTurnSideEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new intelligentMobility.diagram.edit.policies.DrivingBehaviourMetamodelTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = intelligentMobility.diagram.providers.DrivingBehaviourMetamodelParserProvider.getParser(
					intelligentMobility.diagram.providers.DrivingBehaviourMetamodelElementTypes.Turn_2014,
					getParserElement(), intelligentMobility.diagram.part.DrivingBehaviourMetamodelVisualIDRegistry
							.getType(intelligentMobility.diagram.edit.parts.TurnTurnSideEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new ComboDirectEditManager(this, null,
					intelligentMobility.diagram.edit.parts.DrivingBehaviourMetamodelEditPartFactory
