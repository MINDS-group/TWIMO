 ...
 * @generated
 */
public class Driver_ProfileDriverNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public Driver_ProfileDriverNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = intelligentMobility.diagram.providers.DrivingBehaviourMetamodelParserProvider.getParser(
					...
					intelligentMobility.diagram.part.DrivingBehaviourMetamodelVisualIDRegistry.getType(
							intelligentMobility.diagram.edit.parts.Driver_ProfileDriverNameEditPart.VISUAL_ID));
		}
		return parser;
	}
