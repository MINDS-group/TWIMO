 ...
 * @generated
 */
public class PlatoonEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public PlatoonEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new intelligentMobility.diagram.edit.policies.PlatoonItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof intelligentMobility.diagram.edit.parts.PlatoonNameEditPart) {
			((intelligentMobility.diagram.edit.parts.PlatoonNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePlatoonTypeFigure());
			return true;
		}
		return false;
	}
