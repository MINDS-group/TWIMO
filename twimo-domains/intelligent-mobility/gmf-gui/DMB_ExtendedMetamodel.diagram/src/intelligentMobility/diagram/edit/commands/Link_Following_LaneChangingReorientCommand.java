 ...
 * @generated
 */
public class Link_Following_LaneChangingReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public Link_Following_LaneChangingReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof intelligentMobility.Link_Following_LaneChanging) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		intelligentMobility.LaneChanging target = getLink().getLink_laneChanging();
		...
		return intelligentMobility.diagram.edit.policies.DrivingBehaviourMetamodelBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistLink_Following_LaneChanging_4043(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return intelligentMobility.diagram.edit.policies.DrivingBehaviourMetamodelBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistLink_Following_LaneChanging_4043(container, getLink(), source, getNewTarget());
	}
	...
	*/
	protected CommandResult reorientTarget() throws ExecutionException {
		getLink().setLink_laneChanging(getNewTarget());
		return CommandResult.newOKCommandResult(getLink());
	}
	...
	* @generated
	*/
	protected intelligentMobility.Link_Following_LaneChanging getLink() {
		return (intelligentMobility.Link_Following_LaneChanging) getElementToEdit();
	}
