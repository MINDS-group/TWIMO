...
/**
 * This is the item provider adapter for a {@link intelligentMobility.Weather} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WeatherItemProvider 
	...
	public List getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addWeatherTypePropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Weather_slipperiness_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Weather_slipperiness_feature", "_UI_Weather_type"),
				 IntelligentMobilityPackage.eINSTANCE.getWeather_Slipperiness(),
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Weather Type feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addWeatherTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Weather_weatherType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Weather_weatherType_feature", "_UI_Weather_type"),
				 IntelligentMobilityPackage.eINSTANCE.getWeather_WeatherType(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IntelligentMobilityPackage.eINSTANCE.getWeather_Name(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
