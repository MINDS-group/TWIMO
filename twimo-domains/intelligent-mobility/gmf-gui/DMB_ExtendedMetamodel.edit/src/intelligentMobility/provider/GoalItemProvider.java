...
/**
 * This is the item provider adapter for a {@link intelligentMobility.Goal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GoalItemProvider 
	...
	public List getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIsGoalDrivenPropertyDescriptor(object);
			addIsStimulusDrivenPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IntelligentMobilityPackage.eINSTANCE.getGoal_GoalType(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IntelligentMobilityPackage.eINSTANCE.getGoal_Priority(),
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Is Goal Driven feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIsGoalDrivenPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Goal_isGoalDriven_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Goal_isGoalDriven_feature", "_UI_Goal_type"),
				 IntelligentMobilityPackage.eINSTANCE.getGoal_IsGoalDriven(),
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Is Stimulus Driven feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIsStimulusDrivenPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Goal_isStimulusDriven_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Goal_isStimulusDriven_feature", "_UI_Goal_type"),
				 IntelligentMobilityPackage.eINSTANCE.getGoal_IsStimulusDriven(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Goal)object).getGoalType();
