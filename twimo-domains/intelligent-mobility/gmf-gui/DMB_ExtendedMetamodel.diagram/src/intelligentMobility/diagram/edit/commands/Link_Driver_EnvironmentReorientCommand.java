 ...
 * @generated
 */
public class Link_Driver_EnvironmentReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public Link_Driver_EnvironmentReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof intelligentMobility.Link_Driver_Environment) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return intelligentMobility.diagram.edit.policies.DrivingBehaviourMetamodelBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistLink_Driver_Environment_4015(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return intelligentMobility.diagram.edit.policies.DrivingBehaviourMetamodelBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistLink_Driver_Environment_4015(container, getLink(), source, getNewTarget());
	}
	...
	* @generated
	*/
	protected intelligentMobility.Link_Driver_Environment getLink() {
		return (intelligentMobility.Link_Driver_Environment) getElementToEdit();
	}
