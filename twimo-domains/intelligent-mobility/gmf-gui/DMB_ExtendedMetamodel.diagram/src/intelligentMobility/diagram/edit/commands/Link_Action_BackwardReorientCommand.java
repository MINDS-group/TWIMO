 ...
 * @generated
 */
public class Link_Action_BackwardReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public Link_Action_BackwardReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof intelligentMobility.Link_Action_Backward) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		intelligentMobility.Backward target = getLink().getLink_backward();
		...
		return intelligentMobility.diagram.edit.policies.DrivingBehaviourMetamodelBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistLink_Action_Backward_4044(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		intelligentMobility.MobilitySystem container = (intelligentMobility.MobilitySystem) getLink().eContainer();
		return intelligentMobility.diagram.edit.policies.DrivingBehaviourMetamodelBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistLink_Action_Backward_4044(container, getLink(), source, getNewTarget());
	}
	...
	*/
	protected CommandResult reorientTarget() throws ExecutionException {
		getLink().setLink_backward(getNewTarget());
		return CommandResult.newOKCommandResult(getLink());
	}
	...
	* @generated
	*/
	protected intelligentMobility.Link_Action_Backward getLink() {
		return (intelligentMobility.Link_Action_Backward) getElementToEdit();
	}
	...
	* @generated
	*/
	protected intelligentMobility.Backward getOldTarget() {
	...
	* @generated
	*/
	protected intelligentMobility.Backward getNewTarget() {
