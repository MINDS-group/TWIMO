 ...
 * @generated
 */
public class Link_LaneChanging_EnvironmentConditionReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public Link_LaneChanging_EnvironmentConditionReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof intelligentMobility.Link_LaneChanging_EnvironmentCondition) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return intelligentMobility.diagram.edit.policies.DrivingBehaviourMetamodelBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistLink_LaneChanging_EnvironmentCondition_4032(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return intelligentMobility.diagram.edit.policies.DrivingBehaviourMetamodelBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistLink_LaneChanging_EnvironmentCondition_4032(container, getLink(), source, getNewTarget());
	}
	...
	* @generated
	*/
	protected intelligentMobility.Link_LaneChanging_EnvironmentCondition getLink() {
		return (intelligentMobility.Link_LaneChanging_EnvironmentCondition) getElementToEdit();
	}
